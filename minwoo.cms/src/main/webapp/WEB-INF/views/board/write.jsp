...
<body>
	<section id="post">
		<div class="container">
			...
			<form id="boardForm">
				<div>
					제 목 <input name="usbTitle" id="usbTitle" size="80"
						placeholder="제목을 입력해주세요"> <br>
					<br>
				</div>
				<div>
					내 용
					<textarea name="usbContent" id="usbContent" rows="4" cols="100"
						placeholder="내용을 입력해주세요"></textarea>
					<br>
					<br>
				</div>
				<div>
					아이디 <input name="subId" id="subId" placeholder="아이디를 입력해주세요">
				</div>
			</form>
